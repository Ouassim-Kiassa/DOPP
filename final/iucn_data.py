...
# TODO check if index on taxonid_iucn makes sense
...
# def get_merged_data():
#     species_list = load_csv_from_batches(base_path)
#     species_info_df = load_csv_from_batches(species_path)
#     species_df = species_list.merge(species_info_df)
#     species_df = species_df.query("kingdom == 'ANIMALIA'")
#     check_duplicate(species_df)
#     return species_df
